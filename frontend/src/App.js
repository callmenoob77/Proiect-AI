                      ...
                      <>
                          ...
                          <div className="flex flex-col md:flex-row gap-6">
                              <button
                                  ...
                                  className="flex-1 p-6 border-4 rounded-2xl"
                              >
                          ...
                          <button
                              ...
                              className="mt-10 bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 px-12 rounded-xl font-semibold"
                          >
                              Generează întrebarea
                          </button>
                      </>
              ...
              <div className="max-w-4xl mx-auto">
                  <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    {isMultipleChoice ? <ListChecks className="w-4 h-4"/> : <Type className="w-4 h-4"/>}
                      ...
                      <div className="p-8">
                          <div
                              className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6 mb-8 border-l-4 border-purple-600">
                                          ...
                                          <div className="flex items-center mb-3">
                                              {evaluationResult.is_correct ? (
                                                  <>
                                                      ...
                                                      <span
                                                          className="font-bold text-2xl text-gray-800">Excelent!</span>
                                                  </>
                                              ) : evaluationResult.score >= 50 ? (
                                                  <>
                                          ...
                                          {!isMultipleChoice && evaluationResult.details && (
                                              <div className="bg-white/60 rounded-xl p-4 mb-3">
                                                  {evaluationResult.details.keywords_found && evaluationResult.details.keywords_found.length > 0 && (
                                                      <div className="mb-2">
                                                          <p className="font-semibold text-green-700 mb-1">✓ Cuvinte
                                                              cheie găsite:</p>
                                                  ...
                                                  {evaluationResult.details.keywords_missed && evaluationResult.details.keywords_missed.length > 0 && (
                                                      <div>
                                                          <p className="font-semibold text-red-700 mb-1">✗ Cuvinte cheie
                                                              lipsă:</p>
