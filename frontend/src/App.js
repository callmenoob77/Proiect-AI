        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-8 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <button
              ...
              className={`flex-1 p-6 border-4 rounded-2xl transition-all transform hover:scale-105 ${
                answerType === 'multiple' ? 'border-purple-600 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 p-6 border-4 rounded-2xl transition-all transform hover:scale-105 ${
                answerType === 'text' ? 'border-blue-600 bg-blue-50' : 'border-gray-200 hover:border-blue-300'
              }`}
            >
