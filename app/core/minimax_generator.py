...
def genereaza_intrebare_minimax(answer_type: str = "multiple") -> Dict[str, Any]:
    """
    Genereaza un arbore min max si intrebarea
    1. Generez arbori pana obtin unul cu nr acceptabil de frunze (4-10)
    2. Rulez minmax cu alpha-beta pt a obtine:
        - valoarea din radacina
        - nr de frunze vizitate
    3. Formez intrebarea si solutia de referinta
    4. Putem genera multiple choice/text
    """

    max_depth = random.choices([2, 3], weights=[70, 30])[0]
